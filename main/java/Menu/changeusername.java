...
public class changeusername extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        mc.fontRenderer.drawStringWithShadow("Current username: " + mc.getSession().getUsername(),
                this.width / 2 - 100, this.height / 4 + 48 + 110, Color.WHITE.getRGB());
    }
}
