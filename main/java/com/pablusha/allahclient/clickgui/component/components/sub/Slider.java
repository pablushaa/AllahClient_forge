package com.pablusha.allahclient.clickgui.component.components.sub;
...
import com.pablusha.allahclient.clickgui.component.components.Button;
...
public class Slider extends Component {
	...
	public void renderComponent() {
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + parent.parent.getWidth(), parent.parent.getY() + offset + 12, 0x99111111);
		...
		Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset + 8, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 12,hovered ? new Color(0xf3b48b).hashCode() : new Color(0xf3b48b).hashCode());
		GL11.glPushMatrix();
