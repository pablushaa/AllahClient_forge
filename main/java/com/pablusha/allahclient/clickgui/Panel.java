package com.pablusha.allahclient.clickgui;
...
public class Panel {
    ...
    public List<com.pablusha.allahclient.clickgui.Button> buttons = new ArrayList<>();
    ...
    public Panel(int x, int y, int width, int height, Module.Category category) {
        ...
        for (Module module : AllahClient.modules) {
            if (module.category == category) {
                buttons.add(new com.pablusha.allahclient.clickgui.Button(x, y1, width, height, module));
                y1 += height;
            }
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Gui.drawRect(x, y, x + width, y + height, new Color(0xf3b48b).hashCode());
        ...
        if (extended) {
            int y1 = y + height;
            for (com.pablusha.allahclient.clickgui.Button button : buttons) {
                button.x = x;
                button.y = y1;
